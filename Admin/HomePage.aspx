                ...
                <div class="col-lg-8 mx-auto">
                    <div class="fa-mobile-phone">
                        ...
                        <p>
                           ...
                           Tel: (506) 2241-9090  | 2545-0700 | 2241-9080
                        </p>
                        <p>
                            <i class="fa fa-phone fa-fw"></i>
                            Recinto Llorente de Tibás:
                        ...
                        <p>
                            <i class="fa fa-phone fa-fw"></i>
                            Recinto Heredia:
                           Tel: (506) 2261-6061 | 2277-7500
                        </p>
                        <p>
                            <i class="fa fa-phone fa-fw"></i>
                            Sede Aranjuez:
                           Tel: (506) 2256-8197 | 2211-3000
                        </p>
                        <p>
                            <i class="fa fa-phone fa-fw"></i>
                            Sede Puntarenas:
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <p>
                        Búscanos en página oficial de la universidad Hispanoamérica: 
