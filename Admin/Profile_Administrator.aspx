...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_Administrator.aspx.cs" Inherits="Admin_Profile_Administrator" %>
    ...
    <body class="w3-light-grey w3-content" style="max-width: 1600px;" >
      ...
      <nav class="w3-sidebar w3-collapse w3-blue w3-animate-left" style="z-index: 3; width: 300px;" id="mySidebar">
        ...
        <div class="w3-bar-block">
          ...
          <a href="#Crear_Usuarios" onclick="w3_close()" class="w3-bar-item w3-padding w3-text-black" , style="background-color: #A9D0F5"><i class="fa fa-th-large fa-fw w3-margin-right"></i>Crear Usuarios</a>
      ...
      <div class="w3-main" style="margin-left: 300px">
        ...
        <form id="form1" runat="server">
          ...
          <section id="Mantenimientos1" class="content-section text-center">
            <h4 id="mantenimientos1"><b>Mantenimientos</b></h4>
          ...
          <section id="Crear_Usuarios" class="content-section text-center">
            <h4 id="crear_Usuarios"><b>Crear Usuarios Administrativos</b></h4>
              <div class="w3-container w3-padding-large" style="margin-bottom: 32px">
            <div class="container" runat="server">
                <table class="text-center table table-default">
                    <tr>
                        <td>
                            <label class="text-justify">Crear Psicólogo: </label><br />
                        </td>
                        <td>
                           <asp:button id="btn_Crear_Psicologo" runat="server" text="Iniciar" class="btn btn-default btn-lg" postbackurl="~/Admin/New_Psychologist.aspx" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label class="text-justify">Crear Administrador: </label><br />
                        </td>
                        <td>
                           <asp:button id="btn_Crear_Administrador" runat="server" text="Iniciar" class="btn btn-default btn-lg" postbackurl="~/Admin/New_Administrator.aspx" />
                        </td>
                    </tr>
                </table>
