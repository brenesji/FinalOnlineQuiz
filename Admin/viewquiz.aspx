...
<asp:Label ID="Label" runat="server" Font-Size="XX-Large"  Text="Examenes Recientes"/>        
        ...
        <asp:Repeater ID="currrepeater" runat="server" Visible="false" OnItemCommand="currrepeater_ItemCommand">
            <HeaderTemplate>
                <table style="width: 100%">
                    <tr style="background-color: gray; color: white;">
                        <td style="height: 25px; padding-left: 10px; font-weight: bold;">Nombre</td>
                        <td style="height: 25px; padding-left: 10px; font-weight: bold;">Fecha Inicio</td>
                        <td style="height: 25px; padding-left: 10px; font-weight: bold;">Fecha Final</td>
            ...
            <ItemTemplate>
                <tr style="background-color: darkgray;">
                    ...
                    <td style="height: 25px; padding-left: 10px;">
                        <asp:LinkButton ID="lnkquestions" runat="server" CommandName="questions" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' CausesValidation="false">Preguntas</asp:LinkButton>
                    </td>
                    <td style="height: 25px; padding-left: 10px;">
                        <asp:LinkButton ID="lnkView" runat="server" CommandName="responses" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' CausesValidation="false">Respuestas</asp:LinkButton>
                    </td>
                    <td style="height: 25px; padding-left: 10px;">
                        <asp:LinkButton ID="lnkEdit" runat="server" CommandName="edit" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "id") %>' CausesValidation="false">Editar</asp:LinkButton>
                    </td>
    ...
    <br />
    <div id="quizsetup">
        <p><a href="newquiz">Comenzar un nuevo Examen</a></p>
    </div>
    <br />
    <footer>
